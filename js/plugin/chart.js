...
!(function (t, e) {
  ...
  var ue = new de({ _scriptable: (t) => !t.startsWith('on'), _indexable: (t) => 'events' !== t, hover: { _fallback: 'interaction' }, interaction: { _scriptable: !1, _indexable: !1 } }, [
    ...
    function (t) {
      t.set('scale', {
        ...
        t.describe('scale', { _fallback: !1, _scriptable: (t) => !t.startsWith('before') && !t.startsWith('after') && 'callback' !== t && 'parser' !== t, _indexable: (t) => 'borderDash' !== t && 'tickBorderDash' !== t && 'dash' !== t }),
  ...
  function Ne(t, e, i, o, a, r = {}) {
    ...
    for (
      ...
      (d = l[c]), r.backdrop && We(t, r.backdrop), h && (r.strokeColor && (t.strokeStyle = r.strokeColor), s(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, i, o, r.maxWidth)), t.fillText(d, i, o, r.maxWidth), Be(t, i, o, d, r), (o += Number(a.lineHeight));
    t.restore();
  }
  function He(t, e) {
  ...
  function Ri(t, e, i) {
    ...
    const y = () => b || (l(n, x, p) && 0 !== r(n, x)),
      v = () => !b || 0 === r(o, p) || l(o, x, p);
    for (let t = c, i = c; t <= d; ++t) (m = e[t % a]), m.skip || ((p = h(m[s])), p !== x && ((b = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (x = p)));
  ...
  function Vi(t) {
    return { backgroundColor: t.backgroundColor, borderCapStyle: t.borderCapStyle, borderDash: t.borderDash, borderDashOffset: t.borderDashOffset, borderJoinStyle: t.borderJoinStyle, borderWidth: t.borderWidth, borderColor: t.borderColor };
  }
  function Bi(t, e) {
    if (!e) return !1;
    const i = [],
  ...
  class Js extends Hs {
    ...
    _handleMargins() {
      this._margins &&
        ((this._margins.left = Math.max(this.paddingLeft, this._margins.left)), (this._margins.top = Math.max(this.paddingTop, this._margins.top)), (this._margins.right = Math.max(this.paddingRight, this._margins.right)), (this._margins.bottom = Math.max(this.paddingBottom, this._margins.bottom)));
    }
    afterFit() {
    ...
    _computeGridLineItems(t) {
      ...
      for (_ = 0; _ < d; _ += T) {
        ...
        (y = qs(this, _, h)),
          void 0 !== y && ((v = Ae(i, y, o)), c ? (M = k = P = C = v) : (w = S = D = O = v), f.push({ tx1: M, ty1: w, tx2: k, ty2: S, x1: P, y1: D, x2: C, y2: O, width: o, color: a, borderDash: l, borderDashOffset: d, tickWidth: u, tickColor: g, tickBorderDash: p, tickBorderDashOffset: m }));
      }
  ...
  class An {
    ...
    constructor(t, e) {
      ...
      (this.id = i()),
        ...
        (this._dataChanges = []),
        (Pn[this.id] = this),
        r && l ? (bt.listen(this, 'complete', wn), bt.listen(this, 'progress', kn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
    }
    get aspectRatio() {
      const {
  ...
  function Bn(t, e, i, s) {
    ...
    const {
      ...
      let e, i, s, n, o;
      return t.horizontal ? ((e = t.base > t.x), (i = 'left'), (s = 'right')) : ((e = t.base < t.y), (i = 'bottom'), (s = 'top')), e ? ((n = 'end'), (o = 'start')) : ((n = 'start'), (o = 'end')), { start: i, end: s, reverse: e, top: n, bottom: o };
    })(t);
  ...
  function ao(t, e) {
    ...
    let r, l, h, c, d;
    return t.horizontal ? ((d = a / 2), (r = Math.min(i, n)), (l = Math.max(i, n)), (h = s - d), (c = s + d)) : ((d = o / 2), (r = i - d), (l = i + d), (h = Math.min(s, n)), (c = Math.max(s, n))), { left: r, top: h, right: l, bottom: c };
  }
  function ro(t, e, i, s) {
    return t ? 0 : J(e, i, s);
  }
    ...
    const e = ao(t),
      ...
      a = (function (t, e, i) {
        const { enableBorderRadius: s } = t.getProps(['enableBorderRadius']),
          ...
          l = t.borderSkipped,
          h = s || o(n);
        return { topLeft: ro(!h || l.top || l.left, a.topLeft, 0, r), topRight: ro(!h || l.top || l.right, a.topRight, 0, r), bottomLeft: ro(!h || l.bottom || l.left, a.bottomLeft, 0, r), bottomRight: ro(!h || l.bottom || l.right, a.bottomRight, 0, r) };
      })(t, i / 2, s / 2);
    return {
      ...
      inner: {
        ...
        w: i - n.l - n.r,
        h: s - n.t - n.b,
        radius: { topLeft: Math.max(0, a.topLeft - Math.max(n.t, n.l)), topRight: Math.max(0, a.topRight - Math.max(n.t, n.r)), bottomLeft: Math.max(0, a.bottomLeft - Math.max(n.b, n.l)), bottomRight: Math.max(0, a.bottomRight - Math.max(n.b, n.r)) },
      },
    };
  }
  function ho(t, e, i, s) {
    ...
    buildTicks() {
      ...
      const n = (function (t, e) {
        ...
        (k = Math.ceil(m / S) - Math.floor(p / S)),
          ...
          x && b && o && H((r - a) / o, S / 1e3) ? ((k = Math.round(Math.min((r - a) / S, c))), (S = (r - a) / k), (M = a), (w = r)) : _ ? ((M = x ? a : M), (w = b ? r : w), (k = h - 1), (S = (w - M) / k)) : ((k = (w - M) / S), (k = V(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k)));
  ...
  var ma = {
    ...
    afterDatasetsUpdate(t, e, i) {
      const s = (t.data.datasets || []).length,
        n = [];
      let o, a, r, l;
      for (a = 0; a < s; ++a) (o = t.getDatasetMeta(a)), (r = o.dataset), (l = null), r && r.options && r instanceof no && (l = { visible: t.isDatasetVisible(a), index: a, fill: aa(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }), (o.$filler = l), n.push(l);
    ...
    _draw() {
      ...
      this.legendItems.forEach((y, v) => {
        ...
        r.setWidth(this.width),
          x ? v > 0 && S + k + c > this.right && ((P = f.y += _), f.line++, (S = f.x = ft(n, this.left + c, this.right - i[f.line]))) : v > 0 && P + _ > this.bottom && ((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + b + c, this.bottom - e[f.line].height)));
        if (
          ((function (t, e, i) {
  ...
  class va extends Hs {
    ...
    _drawArgs(t) {
      ...
      let r,
        ...
        h,
        c = 0;
      return this.isHorizontal() ? ((l = ft(a, i, n)), (h = e + t), (r = n - i)) : ('left' === o.position ? ((l = i + t), (h = ft(a, s, e)), (c = -0.5 * C)) : ((l = n - t), (h = ft(a, e, s)), (c = 0.5 * C)), (r = s - e)), { titleX: l, titleY: h, maxWidth: r, rotation: c };
    }
    draw() {
      const t = this.ctx,
        e = this.options;
  ...
  function La(t, e, i, s) {
    ...
    return 'center' === l ? ('left' === r ? (g += h) : 'right' === r && (g -= h)) : 'left' === r ? (g -= Math.max(c, u) + n) : 'right' === r && (g += Math.max(d, f) + n), { x: J(g, 0, s.width - e.width), y: J(p, 0, s.height - e.height) };
  }
  function Ea(t, e, i) {
    ...
    getCaretPosition(t, e, i) {
      ...
      return (
        'center' === n
          ...
          : ((m = 'left' === s ? d + Math.max(r, h) + o : 'right' === s ? d + f - Math.max(l, c) - o : this.caretX), 'top' === n ? ((b = u), (_ = b - o), (p = m - o), (x = m + o)) : ((b = u + g), (_ = b + o), (p = m + o), (x = m - o)), (y = b)),
    ...
    _drawColorBox(t, e, i, s, n) {
      ...
      if (n.usePointStyle) {
        ...
        Object.values(r).some((t) => 0 !== t)
          ? (t.beginPath(), (t.fillStyle = n.multiKeyBackground), He(t, { x: e, y: g, w: h, h: l, radius: r }), t.fill(), t.stroke(), (t.fillStyle = a.backgroundColor), t.beginPath(), He(t, { x: i, y: g + 1, w: h - 2, h: l - 2, radius: r }), t.fill())
