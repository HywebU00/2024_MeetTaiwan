          ...
          return (
            se.isEnabled ||
              ...
              ((0 <= t.indexOf('touch') && Ee) || 0 <= t.indexOf('pointer')) &&
                (B(i, Re[0], we, ue, G), B(be, Re[2], _e), B(be, Re[3], _e), Q && B(i, 'click', cf, !0, !0), U && B(i, 'click', tf), Y && B(be, 'gesturestart', mf), H && B(be, 'gestureend', nf), D && B(i, Oe + 'enter', rf), R && B(i, Oe + 'leave', sf), q && B(i, Oe + 'move', qf)),
              (se.isEnabled = !0),
              e && e.type && we(e),
              W && W(se)),
            se
    ...
    ne =
          ...
          if (
            ...
            ae &&
              ...
              (n = He.core.getCache(ae)).spacer
                ? (X = n.pinState)
                : (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = jc(l))), (n.spacer = U = l || Xe.createElement('div')), U.classList.add('pin-spacer'), a && U.classList.add('pin-spacer-' + a), (n.pinState = X = jc(ae))),
      ...
      (ScrollTrigger.enable = function enable() {
        if (
          ...
          (We = Xe.body),
          He && ((Ve = He.utils.toArray), (Ue = He.utils.clamp), (x = He.core.context || Ha), ($e = He.core.suppressOverwrites || Ha), (w = Ne.history.scrollRestoration || 'auto'), (Q = Ne.pageYOffset), He.core.globals('ScrollTrigger', ScrollTrigger), We))
        ) {
          (lt = 1),
