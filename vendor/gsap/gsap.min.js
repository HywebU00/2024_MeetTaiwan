...
!(function (t, e) {
        ...
        return arguments.length
          ? (this._ps !== t &&
              ((this._ps = t)
                ...
                : (Ft(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && Math.abs(this._zTime) !== X && (this._tTime -= X)))),
            this)
          : this._ps;
      }),
    ...
    return (
          ...
          this._onUpdate && !e && Ct(this, 'onUpdate', !0),
            ((v === m && this._tTime >= this.totalDuration()) || (!v && _)) &&
              ((f !== this._start && Math.abs(l) === Math.abs(this._ts)) ||
                this._lock ||
                ((!t && g) || !((v === m && 0 < this._ts) || (!v && this._ts < 0)) || za(this, 1), e || (t < 0 && !_) || (!v && !_ && m) || (Ct(this, v === m && 0 <= t ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (v < m && 0 < this.timeScale()) || this._prom())));
        }
        return this;
      }),
      ...
      (e.getTweensOf = function getTweensOf(e, r) {
        for (var i, n = [], a = Mt(e), s = this._first, o = t(r); s; )
          s instanceof $t ? la(s._targets, a) && (o ? (!Nt || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r : !r || s.isActive()) && n.push(s) : (i = s.getTweensOf(a, r)).length && n.push.apply(n, i), (s = s._next);
        return n;
      }),
            ...
            function _addComplexStringPropTween(t, e, r, i, n, a, s) {
              ...
              for (_.b = r, _.e = i, r += '', (c = ~(i += '').indexOf('random(')) && (i = ob(i)), a && (a((p = [r, i]), t, e), (r = p[0]), (i = p[1])), u = r.match(it) || []; (o = it.exec(i)); )
                (l = o[0]),
                  ...
                  l !== u[g++] && ((d = parseFloat(u[g - 1]) || 0), (_._pt = { _next: _._pt, p: f || 1 === g ? f : ',', s: d, c: '=' === l.charAt(1) ? ka(d, l) - d : parseFloat(l) - d, m: h && h < 4 ? Math.round : 0 }), (m = it.lastIndex));
  ...
  function ke(t, e) {
    ...
    return s.svg && t.getAttribute('transform')
      ...
      : (u !== wr ||
          ...
          t === Re ||
          s.svg ||
          ((n = o.display), (o.display = 'block'), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), Re.appendChild(t)), (u = je(t)), n ? (o.display = n) : Xd(t, 'display'), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Re.removeChild(t))),
  ...
  function xe(t, e, r) {
    var i,
      ...
      l = we({}, r._gsap),
      f = r.style;
    for (n in (l.svg ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[cr] = e), (i = Or(r, 1)), Xd(r, cr), r.setAttribute('transform', a)) : ((a = getComputedStyle(r)[cr]), (f[cr] = e), (i = Or(r, 1)), (f[cr] = a)), ar))
      (a = l[n]) !== (s = i[n]) && 'perspective,force3D,transformOrigin,svgOrigin'.indexOf(n) < 0 && ((o = Ya(a) !== (h = Ya(s)) ? _d(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new _e(t._pt, i, n, o, u - o, vd)), (t._pt.u = h || 0), t._props.push(n));
    we(i, l);
  }
  var Ee,
    De,
      ...
      return (
        ...
        B.translate &&
          (('none' === B.translate && 'none' === B.scale && 'none' === B.rotate) ||
            (F[cr] =
              ('none' !== B.translate ? 'translate3d(' + (B.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== B.rotate ? 'rotate(' + B.rotate + ') ' : '') + ('none' !== B.scale ? 'scale(' + B.scale.split(' ').join(',') + ') ' : '') + ('none' !== B[cr] ? B[cr] : '')),
        ...
        m !== wr &&
          ...
          6 === m.length
            ...
            : ((R = m[6]),
              ...
              (a = m[14]),
              (h = (g = ur(R, z)) * sr),
              g && ((M = O * (v = Math.cos(-g)) + A * (y = Math.sin(-g))), (P = k * v + S * y), (C = R * v + z * y), (A = O * -y + A * v), (S = k * -y + S * v), (z = R * -y + z * v), (D = E * -y + D * v), (O = M), (k = P), (R = C)),
              (l = (g = ur(-w, z)) * sr),
        ...
        for (d in (Fe || Sd(), (this.styles = this.styles || Md(t)), (b = this.styles.props), (this.tween = i), e))
          if ('autoRound' !== d && ((o = e[d]), !pt[d] || !ac(d, e, i, n, t, a)))
            if (((l = typeof o), (f = br[d]), 'function' === l && (l = typeof (o = o.call(i, n, t, a))), 'string' === l && ~o.indexOf('random(') && (o = ob(o)), f)) f(this, t, d, o, i) && (T = 1);
              ...
              if (
                (O && d in O ? ((s = 'function' == typeof O[d] ? O[d].call(i, n, t, a) : O[d]), r(s) && ~s.indexOf('random(') && (s = ob(s)), Ya(s + '') || 'auto' === s || (s += q.units[d] || Ya(yr(t, d)) || ''), '=' === (s + '').charAt(1) && (s = yr(t, d))) : (s = yr(t, d)),
                (h = parseFloat(s)),
                (_ = 'string' === l && '=' === o.charAt(1) && o.substr(0, 2)) && (o = o.substr(2)),
                (u = parseFloat(o)),
                d in dr &&
                  ('autoAlpha' === d && (1 === h && 'hidden' === yr(t, 'visibility') && u && (h = 0), b.push('visibility', 0, x.visibility), Yd(this, x, 'visibility', h ? 'inherit' : 'hidden', u ? 'inherit' : 'hidden', !u)),
